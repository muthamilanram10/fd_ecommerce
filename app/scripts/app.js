...
async function handleClick(orderId) {  
  try {
      // Fetch order details
      const response = await fetch(`http://ec2-43-205-116-125.ap-south-1.compute.amazonaws.com:3000/orders/${orderId}`);
...
async function fetchOrderData() {
  try {
  const response = await fetch(`http://ec2-43-205-116-125.ap-south-1.compute.amazonaws.com:3000/orders`);
